...
const dresscodeContent = [
  ...
  '',
  'Boys / Male Candidates:',
  '- Traditional Kurta Pyjama preferably white or off white color.',
  '- Formal leather shoes or traditional footwear.',
  '- Official Half-Jacket (Provided by Institute at registration desk).',
  '',
  'Girls / Female Candidates:',
  '- Kurta Salwar or Saree preferably white or off white color.',
  '- Formal footwear.',
  '- Official Half-Jacket (Provided by Institute at registration desk).',
  '',
